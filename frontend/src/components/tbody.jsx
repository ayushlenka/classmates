...
export default function TranscriptLayout() {
  ...
  return (
    <div className="bg-[#101010] min-h-screen px-24 pt-24">
      <h1 className="text-white text-4xl font-thin font-archivo mb-8 text-center">Your Generated Schedules</h1>
      ...
      <div className="flex items-center gap-4 bg-white/10 p-5 rounded-2xl mb-10 max-w-4xl mx-auto">
        ...
        <p className="text-white text-lg font-light font-archivo">Here are the schedules you generated in the past.</p>
      </div>

      <div className="grid grid-cols-2 gap-10 max-w-4xl mx-auto">
        {list.map(item => (
          <Link to={`/result/`} key={item.id}>
