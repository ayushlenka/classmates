...
export default function Hero() {
  return (
    <section className="py-20 bg-davisblue text-white">
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <Link
            ...
            className="bg-white text-davisblue px-6 py-3 rounded-md text-lg font-semibold hover:bg-blue-100 transition-colors inline-block"
          >
            Get Started
          </Link>
        </div>
