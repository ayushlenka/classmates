      ...
      <main className="flex flex-col items-center pt-[90px] bg-[#101010]">
        ...
        <header className="flex justify-between items-center w-full px-6 sm:px-12 lg:px-[100px]">
          ...
          <div className="hidden md:flex">
            <a
              className="px-5 py-2 rounded-full bg-[rgba(232,184,255,0.34)] shadow-[0px_0px_20px_0px_rgba(255,255,255,0.45)] text-white text-[16px] sm:text-[18px] font-normal font-inter"
              href="/auth"
            >
              Sign in with Google
            </a>
        ...
        {/* Mobile Menu */}
        {menuOpen && (
          <div className="md:hidden w-full flex flex-col items-end pr-6 pt-2">
            <a
              className="px-5 py-2 rounded-full bg-[rgba(232,184,255,0.34)] shadow-[0px_0px_20px_0px_rgba(255,255,255,0.45)] text-white text-[16px] font-normal font-inter"
              href="/auth"
            >
              Sign in with Google
            </a>
        ...
        <section className="flex flex-col items-center w-full">
          <section className="flex flex-col items-start w-11/12 max-w-[1030px]">
            ...
            <a
              href="/auth"
              className="mt-4 mb-12 px-5 py-2 rounded-full bg-[rgba(188,85,236,0.35)] shadow-[0px_0px_20px_0px_rgba(232,184,255,0.34)] text-white text-[16px] sm:text-[18px] font-medium font-inter"
            >
              Get Started →
            </a>
          </section>
