  ...
  return (
    <div className="bg-[#101010]">
      <main className="flex flex-col items-center pt-[90px] bg-[#101010]">
        ...
        <div className="absolute top-[300px] left-1/4 h-[600px] w-[80vw] max-w-[800px]">
        ...
        {/* Header */}
        <header className="flex justify-between items-center w-full px-6 sm:px-12 lg:px-[100px]">
          <a href="/">
            <img src="logo.png" alt="classmate logo" className="w-10 h-10" />
          </a>

          <section className="flex gap-4 sm:gap-6">
            <a className="px-5 py-2 rounded-full bg-[rgba(232,184,255,0.34)] shadow-[0px_0px_20px_0px_rgba(255,255,255,0.45)] text-white text-[16px] sm:text-[18px] font-normal font-inter" href="#">
              Sign up
            </a>
            <a className="px-5 py-2 rounded-full bg-[rgba(255,255,255,0.2)] text-white text-[16px] sm:text-[18px] font-normal font-inter" href="#">
              Log in
            </a>
          </section>
        </header>
        ...
        <section className="flex flex-col items-center w-full">
          <section className="flex flex-col items-start w-11/12 max-w-[1030px]">
            ...
            <a href="#" className="mt-4 mb-12 px-5 py-2 rounded-full bg-[rgba(188,85,236,0.35)] shadow-[0px_0px_20px_0px_rgba(232,184,255,0.34)] text-white text-[16px] sm:text-[18px] font-medium font-inter">
              Get Started →
            </a>
          </section>

          <section className="flex flex-col items-center">
            <img src="hero.png" alt="transcript generator example" className="w-full max-w-[1240px] h-auto z-20" />
          </section>
          ...
          <section className="flex flex-col items-center mt-48 z-20 text-center px-4">
            ...
            <a href="#" className="px-5 py-2 rounded-full bg-[rgba(188,85,236,0.35)] shadow-[0px_0px_20px_0px_rgba(232,184,255,0.34)] text-white text-[16px] sm:text-[18px] font-medium font-inter z-20">
              Make my schedule →
            </a>
          </section>
