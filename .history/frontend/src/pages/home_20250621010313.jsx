      ...
      <main className="flex flex-col items-center pt-[60px] sm:pt-[90px] bg-[#101010]">
        ...
        <section className="flex flex-col items-center w-full">
          ...
          <section className="flex flex-col items-center mt-48 gap-16 px-4">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-center justify-center">
              {["AI-Powered Recommendations", "Tailored for UC Davis", "Efficient Schedule Building"].map((title, i) => (
                ...
                >
                  <img src={["lucide_lightbulb.svg", "lucide_cap.svg", "mdi_calendar.svg"][i]} alt="icon" className="mt-10 w-[69px] h-[69px]" />
                  ...
                  <p className="text-white text-[16px] sm:text-[18px] font-light text-center font-archivo leading-[26px]">
                    {["Our AI analyzes your academic history and goals to suggest the best classes.", "Built for UCD students, aligned with real graduation requirements.", "Generate balanced schedules that save time and meet your graduation plan."][i]}
                  </p>
                </div>
              ))}
            </div>
          ...
          <section className="flex flex-col items-center mt-48 gap-3 px-4 text-center">
            <h2 className="text-white text-[36px] sm:text-[48px] font-thin font-archivo">
              Join Our Community
            </h2>
            <p className="text-white text-[18px] sm:text-[24px] font-normal leading-[28px] sm:leading-[36px] font-archivo">
              Connect with fellow UC Davis students and stay updated on Classmates.
            </p>
            <a
              href="#"
              className="mt-3 px-5 py-2 rounded-full bg-[rgba(188,85,236,0.35)] shadow-[0px_0px_20px_0px_rgba(232,184,255,0.34)] text-white text-[16px] sm:text-[18px] font-medium font-inter"
            >
              Join Our Discord →
            </a>
          </section>
