...
export default function Header() {
  ...
  return (
    <div className="relative pt-10 bg-[#101010]">
      {/* Background Circles */}
      <div className="absolute top-[-800px] w-[80%] h-0 z-0">
      ...
      {/* Header */}
      <header className="relative flex items-center justify-between px-4 sm:px-8 lg:px-[100px] h-[100px] bg-[#101010] z-10">
        {/* Logo */}
        <a href="/" className="flex-shrink-0 z-10">
          <img src="logo.png" alt="Classmates Logo" className="w-10 h-10" />
        </a>

        {/* Center Nav (absolute true center) */}
        <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden lg:flex z-10">
