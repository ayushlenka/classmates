...
export default function Header() {
  ...
  return (
    <div className="relative pt-10 bg-[#101010]">
      ...
      {/* Header */}
      <header className="flex items-center justify-between px-6 sm:px-12 md:px-[100px] h-[100px] bg-[#101010]">
        {/* Logo */}
        ...
        {user && (
          <a
            ...
            className="hidden md:inline-block text-white font-[Inter] text-lg px-4 py-2 bg-white/20 rounded-full ml-6"
          >
            Log out
          </a>
        )}
